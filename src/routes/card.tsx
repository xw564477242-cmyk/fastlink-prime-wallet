      ...
      <div className="px-6 pt-4">
        ...
        >
          ...
          <div className="flex items-start justify-between text-white">
            <div>
              ...
              <p className="mt-1 text-xs text-white/80">U Card · {tab === "virtual" ? "Virtual" : "Physical"}</p>
            </div>
        ...
        <div className="mt-5 grid grid-cols-3 gap-2">
          <button
            ...
            className="flex flex-col items-center gap-2 rounded-2xl bg-surface py-4 text-xs font-medium active:scale-95"
          >
            <div className={`grid h-10 w-10 place-items-center rounded-full ${frozen ? "bg-accent/20 text-accent" : "bg-primary/15 text-primary"}`}>
              {frozen ? <Sun className="h-5 w-5" /> : <Snowflake className="h-5 w-5" />}
            </div>
          ...
          <button className="flex flex-col items-center gap-2 rounded-2xl bg-surface py-4 text-xs font-medium active:scale-95">
            <div className="grid h-10 w-10 place-items-center rounded-full bg-primary/15 text-primary">
        ...
        <div className="mt-5 rounded-2xl bg-surface p-5">
          ...
          <div className="mt-3 divide-y divide-border">
            ...
            <Detail label="CVV" value={showPin ? "428" : "•••"} />
