  ...
  return (
    <MobileShell>
      ...
      <div className="flex items-center justify-between px-6 pt-2">
        ...
        <Link to="/assets/cards" className="text-xs font-semibold text-primary">
          {t("assets.linkCards")}
        </Link>
      </div>
      ...
      <div className="px-6 pt-4">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          {t("assets.fiat.count", { n: fiat.length })}
        </p>
      </div>
      ...
      <div className="mt-6 px-6">
        <Link
          to="/convert"
          className="flex items-center justify-center gap-2 rounded-2xl bg-primary/15 py-3 text-xs font-semibold text-primary"
        >
