...
function HistoryPage() {
  ...
  const TXNS = useMemo(
    () => [
      { id: "t1", kind: "card" as Kind, title: "Apple Pay · Uniqlo", subtitle: "Virtual Card •• 4829", amount: -48.2, currency: "USD", time: t("home.time.today1402"), status: "completed" as const },
      { id: "t2", kind: "deposit" as Kind, title: t("home.tx.deposit"), subtitle: "TRC20 · 5 conf.", amount: 500, currency: "USDT", time: t("home.time.today0912"), status: "completed" as const },
      { id: "t3", kind: "convert" as Kind, title: t("home.tx.convert"), subtitle: "1 USDT = 0.9187 EUR", amount: -200, currency: "USDT", time: t("home.time.yesterday"), status: "completed" as const },
      { id: "t4", kind: "transfer" as Kind, title: t("home.tx.transfer"), subtitle: "FastLink @alex", amount: 120, currency: "USDT", time: t("home.time.jul2"), status: "completed" as const },
      { id: "t5", kind: "withdraw" as Kind, title: "Withdraw to 0x8B2…4E9", subtitle: "ERC20 · 3/12", amount: -250, currency: "USDT", time: t("home.time.jul2"), status: "pending" as const },
      { id: "t6", kind: "card" as Kind, title: "Starbucks Reserve", subtitle: "Physical Card •• 9130", amount: -8.4, currency: "USD", time: t("home.time.jul2"), status: "completed" as const },
      { id: "t7", kind: "deposit" as Kind, title: t("home.tx.deposit"), subtitle: "BEP20", amount: 1000, currency: "USDT", time: t("home.time.jul2"), status: "completed" as const },
    ],
    [t],
  );
            ...
            return (
              <div key={tx.id} className="flex items-center gap-3 rounded-2xl bg-surface p-4">
                ...
                <div className="text-right">
                  <p translate="no" className={`text-sm font-semibold tabular-nums ${pos ? "text-primary" : "text-foreground"}`}>
                    {pos ? "+" : ""}
